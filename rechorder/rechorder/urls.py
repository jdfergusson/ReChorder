...
urlpatterns = [
    ...
    re_path(r'^set/(?P<set_id>[0-9]+)/removes-ong$', views.set_remove_song, name='set.remove_song'),
    ...
    re_path(r'^item-in-set/(?P<item_in_set_id>[0-9]+)/set-key$', views.set_song_set_key, name="item_in_set.set_key"),
